...
#define LIST_OF_SETTINGS(M) \
    ...
    M(SettingBool, input_format_csv_null_as_default, false, "For CSV format initialize null fields with default values if data type of this field is not nullable") \
    \
