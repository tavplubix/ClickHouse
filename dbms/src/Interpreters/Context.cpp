...
{
    return shared->database_catalog->getDatabase(database_name, *this);
}
...
{
    //FIXME Check it's not global _temporary_and_exteral_tables database. It can be access only by internal server queries
