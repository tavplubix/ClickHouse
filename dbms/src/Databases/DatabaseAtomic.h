...
private:
    ...
    static constexpr size_t reschedule_time_ms = 500;

    //TODO store path in DatabaseWithOwnTables::tables
    std::map<String, String> table_name_to_path;
    using TableWithDropTime = std::pair<StoragePtr, time_t>;
    using TableWithDropTimeList = std::list<TableWithDropTime>;
    TableWithDropTimeList tables_to_drop;
